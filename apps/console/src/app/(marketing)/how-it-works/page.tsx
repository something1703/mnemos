        ...
        <div className="mx-auto max-w-3xl px-5 md:px-8">
          ...
          <div className="flex flex-col gap-3">
            {INVARIANTS.map((inv, i) => (
              <Reveal key={inv.n} delay={i * 0.05}>
                <Card>
                  <CardBody className="flex items-start gap-4">
                    <span className="mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full border border-synapse-edge bg-synapse-fill font-mono text-xs text-synapse">
                      {inv.n}
                    </span>
